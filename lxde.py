...
print("downloading ngrok and executing lxde on :1...")
os.system('DISPLAY=:1 startlxde > /tmp/lxde.log && wget -c https://bin.equinox.io/c/bNyj1mQVY4c/ngrok-v3-stable-linux-amd64.tgz -O - | tar -xz')
